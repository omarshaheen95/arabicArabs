...
use App\Http\Requests\Manager\StoryAssignmentRequest;
...
class StoryAssignmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.stories_assignments.index', compact('title','grades', 'schools'));
    }
    ...
    public function create()
    {
        ...
        return view('manager.stories_assignments.create', compact('title','grades', 'schools'));
    }
    ...
    public function store(StoryAssignmentRequest $request)
    {
        ...
        return redirect()->route('manager.story_assignment.index')->with('message',t('Successfully Added'));
    }
