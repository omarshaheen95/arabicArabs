...
var KTDashboard = function() {
    ...
    var profitShare_2 = function() {
        if (!KTUtil.getByID('kt_chart_profit_share_2')) {
            return;
        }

        var randomScalingFactor_2 = function() {
            return Math.round(Math.random() * 100);
        };
        ...
        var ctx_2 = KTUtil.getByID('kt_chart_profit_share_2').getContext('2d');
        var myDoughnut_2 = new Chart(ctx_2, config_2);
    }
