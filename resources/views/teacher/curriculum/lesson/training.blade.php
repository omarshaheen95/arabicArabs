                        ...
                        <div class="box-shado-question">
                            <div class="bg-light text-secondary font-weight-bold py-3 px-4">
                                <div class="row align-items-center">
                                    <div class="col-md-4"><a href="{{route('teacher.curriculum.lesson', [$lesson->id, 'learn'])}}"
                                                             class="btn btn-danger btn-lg"><i
                                                class="fa fa-arrow-right"></i> {{t('back to Learning')}} </a></div>
                                    <div class="col-md-4 text-center"><h3>{{$lesson->translate('ar')->name}}
                                            - {{$lesson->translate('en')->name}}</h3></div>
                                    <div class="col-md-4 text-left"><a href="{{route('teacher.curriculum.lesson', [$lesson->id, 'test'])}}"
                                                                       class="btn btn-info btn-lg">{{t('Go to the assessment')}}
                                ...
                                <div class="question-list">
                                    ...
                                    @foreach($tf_questions as $key => $tf_question)
                                        <div class="question-item @if($loop->first) active @endif" id="{{$counter}}">
                                            <h3> أكد إذا كانت هذه الجمل صواب أم خطأ - Confirm whether these sentences
                                                are true or false</h3>
                                    ...
                                    @foreach($c_questions as $key => $c_question)
                                        <div class="question-item" id="{{$counter}}">
                                            <h3> اختر الإجابة الصحيحة - Choose the correct answer</h3>
                                            <div class="row mt-4 justify-content-center">
                                                <div class="col-8">
                                                    <div class="w-100 text-center mt-4">
                                    ...
                                    @foreach($m_questions as $key => $m_question)
                                        <div class="question-item" id="{{$counter}}">
                                            <h3> اسحب الإجابات إلى الأماكن الصحيحة في الأسفل – Drag the answers in the
                                                right places below </h3>
                                            <div class="row mt-4 justify-content-center">
                                                <div class="col-8">
                                                    <div class="w-100 text-center mt-4">
                                                                ...
                                                                <div class="col-lg-8">
                                                                    <ul class="connectedNoSortable list-unstyled m-0 font-bold active text-right m-0 p-0">
                                                                        ...
                                                                        @foreach($m_question->matches as $match)
                                                                            <li class="ui-state-default mb-2"><span
                                                                                    class="ml-3"></span>
                                                                ...
                                                                <div class="col-lg-4 ">
                                                                    <div class="position-relative">
                                                                        ...
                                                                        <ul id="match_{{$m_question->id}}_answer" question-id="{{$counter}}"
                                                                            class="sortable2 connectedSortable list-unstyled m-0 font-bold active text-center m-0 p-0">
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    @foreach($s_questions as $key => $s_question)
                                        <div class="question-item" id="{{$counter}}">
                                            <h3> Drag and order the answers in the below box - اسحب ورتب الإجابات في
                                                المكان أدناه </h3>
                                            <div class="row mt-4 justify-content-center">
                                                <div class="col-8">
                                                    <div class="w-100 text-center mt-4">
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-md-12">
                                                        <ul id="sort_{{$s_question->id}}_answer"
                                                            class="sortable1 connectedSortable list-unstyled font-bold text-center d-flex justify-content-around">
                                                            @foreach($s_question->sort_words()->inRandomOrder()->get() as $word)
                                                                <li class="ui-state-default mb-2"
                                                                    data-id="{{$word->id}}">
                                                                    <div>
