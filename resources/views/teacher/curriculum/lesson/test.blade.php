            ...
            <div class="container text-right">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="" id="term_form" >
                            {{csrf_field()}}

                            <div class="box-shado-question">
                                <div class="bg-light text-secondary font-weight-bold py-3 px-4">
                                    <div class="row align-items-center">
                                        <div class="col-md-4 mob-text-center" style="font-size: 20px;color: #000;"> {{$lesson->translate('ar')->name}} - {{$lesson->translate('en')->name}}</div>
                                ...
                                <div class="p-50" style="border: 3px #067af1 solid;">
                                    <div class="question-list">
                                        ...
                                        @foreach($questions as $question)
                                            @if($loop->first)
                                                @if($question->type == 1)
                                                    <div class="question-item active" id="{{$counter}}">
                                                                        ...
                                                                        @foreach($question->matches()->inRandomOrder()->get() as $match)
                                                                            <li class="ui-state-default mb-2" data-id="{{$match->id}}">
                                                                                <div>
                                                                                    ...
                                                                                    <input type="hidden" name="re[{{$match->id}}]" id="" value="{{$match->id}}" >
                                                                                </div>
                                                                            </li>
                                                                        @endforeach
                                                                    </ul>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-8">
                                                                                <ul class="connectedNoSortable list-unstyled m-0 font-bold active text-right m-0 p-0">
                                                                                    ...
                                                                                    @foreach($question->matches as $match)
                                                                                        <li class="ui-state-default mb-2"><span class="ml-3"></span> <text>{{$match->content}}</text>    </li>
                                                                                        @php
                                                                                            $n_counter ++;
                                                                                        @endphp
                                                                                    @endforeach
                                                                            ...
                                                                            <div class="col-lg-4">
                                                                                <div class="position-relative">
                                                                                    ...
                                                                                    <ul id="" question-id="{{$counter}}" class="sortable2 connectedSortable list-unstyled m-0 font-bold active text-center m-0 p-0">
                                                                                    </ul>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                ...
                                                @elseif($question->type == 4)
                                                    <div class="question-item active" id="{{$counter}}">
                                                        <h3 class="text-danger"> Drag and order the answers in the below box - اسحب ورتب الإجابات في المكان أدناه </h3>
                                                        <hr />
                                                        <div class="row mt-4 justify-content-center">
                                                            <div class="col-8">
                                                                <div class="w-100 text-center mt-4">
