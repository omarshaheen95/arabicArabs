                    ...
                    <div class="exam-card box-shado-question">
                        <div class="exam-body question-list">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <a href="{{route('teacher.lesson', [$lesson->id,'learn'])}}" class=" btn btn-theme px-5">
                                ...
                                {{--                                </div>--}}
                                {{--                            @endif--}}
                                <a href="{{route('teacher.lesson', [$lesson->id,'test'])}}" class=" btn btn-theme px-5">
                                    الاختبار
                                    ...
                                    <div class="exercise-box-body">
                                        <div class="exercise-question">
                                            ...
                                            <div class="exercise-question-answer text-center my-4">
                                                ...
                                                @if(!is_null($tf_question->getFirstMediaUrl('t_imageQuestion')))
                                    ...
                                    <div class="exercise-box-body">
                                        <div class="exercise-question">
                                            ...
                                            <div class="exercise-question-answer text-center my-4">
                                                ...
                                                @if(!is_null($c_question->getFirstMediaUrl('t_imageQuestion')))
                                    ...
                                    <div class="exercise-box-body">
                                        <div class="exercise-question">
                                            <div class="exercise-question-data border-0">
                                                ...
                                                <div class="exercise-question-answer text-center my-4">
                                                    @if(!is_null($m_question->getFirstMediaUrl('t_imageQuestion')))
                                    ...
                                    <div class="exercise-box-body">
                                        <div class="exercise-question">
                                            <div class="exercise-question-data border-0">
                                                ...
                                                <div class="exercise-question-answer text-center my-4">
                                                    @if(!is_null($s_question->getFirstMediaUrl('t_imageQuestion')))
...
{{--                                        class="txt" style="font-size: 18px">إنهاء</span></a>--}}
                            </div>
                            <div class="text-center">
