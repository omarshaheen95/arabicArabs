...
@section('content')
    ...
    @endif
    <div class="row">
        <form class="form" id="form_data" action="{{route('teacher.update-password')}}" method="post">
            @csrf
...
@section('script')
    ...
    {!! JsValidator::formRequest(\App\Http\Requests\Teacher\TeacherPasswordRequest::class, '#form_data'); !!}
@endsection
