    ...
    <main class="login-page login-student">
        ...
        <div class="login-form">
            ...
            <div class="header">
                ...
                <h1 class="title">{{t('Teacher Sign In')}}</h1>
            </div>

            <div class="form" >
                <form method="POST" action="{{ url('teacher/login') }}"  class="needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="password" class="form-label d-block">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="/teacher/password/reset" class="link">{{t('Forget Password ?')}}</a>
                            </div>
                        </label>
