...
@section('actions')
        <a href="{{route('teacher.story_assignment.create')}}" class="btn btn-primary btn-elevate btn-icon-sm me-2">
        ...
        <ul class="dropdown-menu">
                <li>
                    <a class="dropdown-item" href="#!"
                       onclick="excelExport('{{route('teacher.story_assignment.export')}}')">{{t('Export')}}</a>
                </li>
...
@section('script')
    <script>
        var DELETE_URL = "{{ route('teacher.story_assignment.destroy') }}";
        var TABLE_URL = "{{ route('teacher.story_assignment.index') }}";
        var TABLE_COLUMNS = [
            {data: 'id', name: 'id'},
