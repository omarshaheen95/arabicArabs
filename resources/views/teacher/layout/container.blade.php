        ...
        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
            ...
            <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                <div class="kt-aside__brand-logo w-100">
                    <a href="{{ url("/teacher/home") }}" class="w-100 text-center">
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item  @if(Request::is('teacher/home*') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('teacher.home') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-protection"></i>
                                <span class="kt-menu__link-text">الرئيسة</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Request::is('teacher/students_school*') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('teacher.students_school.index') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">طلاب المدرسة</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Request::is('teacher/my_students*') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('teacher.student.my_students') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">طلابي</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Request::is('teacher/students_tests*') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('teacher.students_tests.index') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                        ...
                        <li class="kt-menu__item  @if(Request::is('teacher/students_assignment*') ) kt-menu__item--active @endif"
                            ...
                            <a href="{{ route('teacher.student_assignments.index') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">متابعة واجبات الدروس</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Request::is('teacher/students_record*') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('teacher.students_record.index') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">تسجيلات القصص للطلاب</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Request::is('teacher/student_story_assignments*') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('teacher.student_story_assignments.index') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">متابعة واجبات القصص</span>
                            </a>
                        </li>
                        <li class="kt-menu__item kt-menu__item--submenu   @if(Request::is('teacher/level*') ) kt-menu__item--active @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                    <span class="kt-menu__link-icon">
                                        <i class="kt-menu__link-icon flaticon2-layers-1"></i>
                                    </span>
                                <span class="kt-menu__link-text">المناهج والصفوف</span>
                                <i class="kt-menu__ver-arrow @if(app()->getLocale() == 'ar') la la-angle-left @else la la-angle-right @endif"></i>
                            </a>
                ...
                <div class="kt-header__topbar">
                    ...
                    @php
                        $notifications = \App\Models\Notification::query()->where(function ($query){
                            ...
                            })->where('notifiable_type', \App\Models\teacher::class)
...
{{--                                            {{ route('teacher.notification.read_all') }}--}}
...
{{--                                                    {{ route('teacher.notification.show', $notification->id) }}--}}
                                                <a href=""
...
{{--                                {{route('teacher.password.update')}}--}}
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                ...
                <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                    @if(!Request::is('teacher/home') && Route::currentRouteName() != 'teacher.user.review')
                        <div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{ url('/teacher/home') }}">الرئيسة</a>
                                </li>
                                @stack('breadcrumb')
                            </ul>
                        </div>
...
<script type="text/javascript">
    ...
    function notifyMe(notify) {
        ...
        $('#notification_list').prepend(" <a href=\"/teacher/notification/"+ notify.id +"\"\n" +
            "                                                   class=\"kt-notification__item\">\n" +
            "                                                    <div class=\"kt-notification__item-icon\">\n" +
            "                                                        <i class=\"flaticon2-notification kt-font-success\"></i>\n" +
            "                                                    </div>\n" +
    ...
    var channel = pusher.subscribe('teachers');
    channel.bind('teacher-notification', call_back);

    var user_channel = pusher.subscribe('user_{{auth()->user()->id}}');
    user_channel.bind('teacher-notification', call_back);
