    ...
    <div class="dropdown with-filter">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#!"
                   onclick="excelExport('{{route('supervisor.stories_tests.export_excel')}}')">{{t('Export')}}</a></li>
        </ul>
    </div>
...
@section('filter')
    <div class="row">
        ...
        <div class="col-lg-3 mb-2">
            ...
            <select name="student_grade" class="form-select" data-control="select2"
        ...
        <div class="col-lg-3 mb-2">
            ...
            <select name="story_id" id="story_id" class="form-select" data-control="select2"
                    data-placeholder="{{t('Select Story')}}" data-allow-clear="true">
                <option></option>
            </select>
        </div>
        ...
        <div class="col-lg-3 mb-2">
            ...
            <input autocomplete="disabled" class="form-control form-control-solid" name="date_range" value=""
                   placeholder="{{t('Pick date range')}}" id="date_range"/>
...
@section('script')
    ...
    <script>
        ...
        var TABLE_URL = "{{ route('supervisor.stories_tests.index') }}";
        var TABLE_COLUMNS = [
            {data: 'id', name: 'id'},
