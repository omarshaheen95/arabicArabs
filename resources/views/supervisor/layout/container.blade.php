        ...
        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
            ...
            <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                <div class="kt-aside__brand-logo w-100">
                    <a href="{{ url("/supervisor/home") }}" class="w-100 text-center">
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item  @if(Request::is('supervisor/home*') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('supervisor.home') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-protection"></i>
                                <span class="kt-menu__link-text">الرئيسة</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Route::is('supervisor.teacher.index') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('supervisor.teacher.index') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-user-outline-symbol"></i>
                                <span class="kt-menu__link-text">المعلمين</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Route::is('supervisor.teacher.statistics') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('supervisor.teacher.statistics') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-user-outline-symbol"></i>
                                <span class="kt-menu__link-text">إحصائيات المعلمين</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Route::is('supervisor.student.index') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('supervisor.student.index') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">الطلاب</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Route::is('supervisor.student.studentLessonTest') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('supervisor.student.studentLessonTest') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">اختبارات الدروس</span>
                            </a>
                        </li>

                        <li class="kt-menu__item  @if(Route::is('supervisor.student.studentStoryTest') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('supervisor.student.studentStoryTest') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">اختبارات القصص</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Route::is('supervisor.student.studentLessonAssignment') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('supervisor.student.studentLessonAssignment') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">واجبات الدروس</span>
                            </a>
                        </li>
                        <li class="kt-menu__item  @if(Route::is('supervisor.student.studentStoryAssignment') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('supervisor.student.studentStoryAssignment') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-group"></i>
                                <span class="kt-menu__link-text">واجبات القصص</span>
                            </a>
                        </li>
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                            ...
                            <div class="kt-notification">
                                <a href="{{route('supervisor.profile.show')}}" class="kt-notification__item">
                                ...
                                <a href="{{route('supervisor.password.show')}}" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                        <i class="flaticon2-calendar-3 kt-font-success"></i>
                                    </div>
                                    <div class="kt-notification__item-details">
                                    ...
                                    <form id="logout-form" action="{{ url("/supervisor/logout") }}" method="POST"
                                          style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                    <a href="{{ url("/supervisor/logout") }}" onclick="event.preventDefault();
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                ...
                <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                    @if(!Request::is('supervisor/home'))
                        <div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{ url('/supervisor/home') }}">الرئيسة</a>
                                </li>
                                @stack('breadcrumb')
                            </ul>
                        </div>
                    ...
                    @endif
                        @if(Session::has('account-message') || Auth::user()->active == 0 || Auth::user()->approved == 0)
...
<script type="text/javascript">
    ...
    var channel = pusher.subscribe('supervisors');
    channel.bind('supervisor-notification', call_back);

    var user_channel = pusher.subscribe('user_{{auth()->user()->id}}');
    user_channel.bind('supervisor-notification', call_back);
