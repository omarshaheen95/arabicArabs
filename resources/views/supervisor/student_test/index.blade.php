        ...
        <div class="col-md-12">
            <div class="kt-portlet kt-portlet--height-fluid">
                ...
                <div class="kt-portlet__body">
                    <form class="kt-form kt-form--fit kt-margin-b-20" action="{{route('supervisor.student.studentLessonTestExport')}}" method="post">
                        {{csrf_field()}}
...
@section('script')
    ...
    <script>
      ...
      <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                    ...
                    @endif
                    ajax: {
                        url : '{{ route('supervisor.student.studentLessonTest') }}',
                        data: function (d) {
                            d.grade = $("#grade").val();
            ...
            $('select[name="grade"]').change(function () {
                var id = $(this).val();
                var url = '{{ route("supervisor.getLessonsByGrade", ":id") }}';
