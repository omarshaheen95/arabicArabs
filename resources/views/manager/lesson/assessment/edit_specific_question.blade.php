...
@section('content')
    ...
    <div class="row">
        ...
        <div class="tab-content py-5">
            ...
            @if(isset($t_f_questions) && count($t_f_questions))
                <div class="tab-pane show active" id="kt_tabs_1_1" role="tabpanel">
            ...
            @if(isset($c_questions) && count($c_questions))
                    <div class="tab-pane show active" id="kt_tabs_1_2" role="tabpanel">
            ...
            @if(isset($m_questions) && count($m_questions))
                    <div class="tab-pane show active" id="kt_tabs_1_3" role="tabpanel">
                                ...
                                @foreach($m_questions as $m_question)
                                    <div class="form-group row">
                                        <div class="col-lg-9">
                                            ...
                                            <input type="hidden" name="mark[{{$m_question->id}}]" value="{{$mark}}">
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="d-flex">
                                                <label>{{t('Attachment')}} :</label>
            ...
            @if(isset($s_questions) && count($s_questions))
                    <div class="tab-pane show active" id="kt_tabs_1_4" role="tabpanel">
                        <form enctype="multipart/form-data" id="sort_form"
                              class="form-data"
                              action="{{ route('manager.lesson.assessment.update', [$lesson->id, 4]) }}"
                              method="post">
                            @csrf
