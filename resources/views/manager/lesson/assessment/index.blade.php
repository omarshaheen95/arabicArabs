...
@section('title',$title)
@section('actions')
    <a href="{{route('manager.lesson.assessment.edit', [$lesson->id])}}" target="_blank" class="btn btn-primary btn-elevate btn-icon-sm me-2">
...
@section('script')
    <script>
        var DELETE_URL = "{{route('manager.lesson.assessment.delete-question') }}";
        var TABLE_URL = "{{route('manager.lesson.assessment.index', $lesson) }}";
