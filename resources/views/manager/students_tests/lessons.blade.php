...
@section('actions')
    ...
    <div class="dropdown with-filter">
        ...
        <ul class="dropdown-menu">
            @can('export lesson tests')
                <li><a class="dropdown-item" href="#!"
                       onclick="excelExport('{{route('manager.lessons_tests.export_excel')}}')">{{t('Export')}}</a></li>
...
@section('script')
    <script>
        var DELETE_URL = "{{ route('manager.lessons_tests.destroy') }}";
        var TABLE_URL = "{{ route('manager.lessons_tests.index') }}";
        var TABLE_COLUMNS = [
            {data: 'id', name: 'id'},
