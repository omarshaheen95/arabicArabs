        ...
        <ul class="dropdown-menu">
            @can('export story tests')
                <li><a class="dropdown-item" href="#!"
                       onclick="excelExport('{{route('manager.stories_tests.export_excel')}}')">{{t('Export')}}</a></li>
...
@section('script')
    <script>
        var DELETE_URL = "{{ route('manager.stories_tests.destroy') }}";
        var TABLE_URL = "{{ route('manager.stories_tests.index') }}";
        var TABLE_COLUMNS = [
            {data: 'id', name: 'id'},
