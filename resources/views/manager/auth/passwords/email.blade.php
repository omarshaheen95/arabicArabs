...
@section('content')
    ...
    <main class="login-page login-student">
        <div class="login-form">
            ...
            <div class="form">
                <form method="POST" action="{{ url('/manager/password/email')}}" class="needs-validation " novalidate>
                    @csrf
                    <div class="form-group">
                        <label for="password" class="form-label d-block">
                            <div class="d-flex justify-content-between">
                                <span>{{t('Email')}}</span>
                                <a href="/manager/login" class="link">{{t('Login')}}</a>
                            </div>
                        </label>
                        <div class="form-icon">
                                <span class="icon">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" class="form-control" placeholder="ex: example@domain.com" required>
                        </div>
                        @if ($errors->has('email'))
