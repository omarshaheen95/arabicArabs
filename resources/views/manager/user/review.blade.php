                ...
                <div class="kt-portlet__body">
                    <div class="kt-widget kt-widget--user-profile-3">
                        <div class="kt-widget__top">
                            ...
                            @if($user->school->logo)
                            <div class="kt-widget__media kt-hidden-">
                                <img src="{{ $user->school->logo }}" alt="image">
                            </div>
                            @endif
                            <div class="kt-widget__content">
                                <div class="kt-widget__head">
                                    <label href="#" class="kt-widget__username">
                                        {{t('School')}} : {{ $user->school->name }}
                                ...
                                <div class="kt-widget__subhead">
                                    <a href="mailTo:{{ $user->school->email }}"><i
                                            class="flaticon2-new-email"></i> {{ $user->school->email }}</a>
                                    <br/>
                                    <a href="#"><i class="flaticon2-phone"></i> {{ $user->school->mobile }}</a>
                                </div>
                                <div class="kt-widget__subhead">
                                    <a href="#"> <i
                                            class="flaticon2-calendar-7"></i> {{ t('member since : ') .' '. $user->school->created_at->format('d-m-Y') }}
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="{{route('manager.user.report',[$user->id])}}" class="btn btn-danger"><i
