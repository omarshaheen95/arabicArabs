...
@section('actions')
    ...
    <div class="dropdown with-filter">
        ...
        <ul class="dropdown-menu">
            @can('export user works')
                <li>
                    <a class="dropdown-item" href="#!"
                       onclick="excelExport('{{route('manager.students_works.export')}}')">{{t('Export')}}</a>
                </li>
            @endcan

            @can('delete user works')
...
@section('script')
    ...
    <script>
        ...
        var TABLE_URL = "{{ route('manager.students_works.index') }}";
        var TABLE_COLUMNS = [
            {data: 'id', name: 'id'},
