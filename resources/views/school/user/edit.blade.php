...
@section('content')
    <form action="{{ isset($user) ? route('school.student.update', $user->id): route('school.student.store') }}"
...
@section('script')
    ...
    {!! JsValidator::formRequest(\App\Http\Requests\School\UserRequest::class, '#form-profile-save'); !!}
