    ...
    <div class="row">
        <div class="col-xl-10 offset-1">
            <div class="kt-portlet">
                ...
                <form enctype="multipart/form-data" id="form_information" class="kt-form kt-form--label-right" action="{{ isset($user) ? route('school.student.update', $user->id): route('school.student.store') }}" method="post">
                    {{ csrf_field() }}
                    @if(isset($user))
