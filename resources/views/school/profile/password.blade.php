...
@section('content')
    ...
    @endif
    <div class="row">
        <form class="form" id="form_data" action="{{route('school.update-password')}}" method="post">
            @csrf
...
@section('script')
    ...
    {!! JsValidator::formRequest(\App\Http\Requests\School\SchoolPasswordRequest::class, '#form_data'); !!}
@endsection
