...
@section('title', t('School Sign In'))
...
@section('content')
    <main class="login-page login-student">
        ...
        <div class="login-form">
            ...
            <div class="header">
                <div class="pic">
                    <img src="{{asset('assets_v1/web_assets/img/login-student.svg')}}" alt="">
                </div>
                <h1 class="title">{{t('School Sign In')}}</h1>
            </div>

            <div class="form" >
                <form method="POST" action="{{ url('/school/login') }}"  class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        <label for="password" class="form-label d-block">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="password/reset" class="link">{{t('Forget Password ?')}}</a>
                            </div>
                        </label>
...
{{--                                <a href="{{url('/school/register')}}" class="btn btn-light border w-100"> {{t('Sign Up')}}--}}
{{--                                </a>--}}
{{--                            </div>--}}
                        </div>
                    </div>
