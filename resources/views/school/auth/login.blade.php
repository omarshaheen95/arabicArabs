                        ...
                        <div class="kt-login__body">
                            ...
                            <div class="kt-login__signin">
                                <div class="kt-login__form">
                                    <form class="kt-form" action="{{ url('school/login') }}" method="post">
                                        {{ csrf_field() }}

                                        <div class="form-group">
                                            <input class="form-control {{ $errors->has('email') ? ' has-error' : '' }}" type="text" placeholder="البريد الإلكتروني" name="email" autocomplete="off">
                                            @if ($errors->has('email'))
                                        ...
                                        <div class="form-group">
                                            <input class="form-control form-control-last {{ $errors->has('password') ? ' has-error' : '' }}" type="password" placeholder="كلمة المرور" name="password">
                                        ...
                                        <div class="kt-login__extra">
                                            ...
                                            <a href="/school/password/reset">نسيت كلمة المرور ؟</a>
                                        </div>
                                        <div class="kt-login__actions">

                                            <input type="submit" id="" class="btn btn-danger btn-pill btn-elevate" value="تسجيل الدخول">
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content" style="background: linear-gradient(to right,#39B448,#31ab3f);">
                <div class="kt-login__section">
                    <div class="kt-login__block text-center">
                        ...
                        <h3 class="kt-login__title" style="font-size: 2.2rem">إدارة المدرسة</h3>
