...
<head>
    ...
    <meta name="description" content="{{ isset(cached()->name) ? cached()->name:'Usage Report' }}">
...
<div class="page">
    <div class="subpage-w" style="padding-bottom: 0; border:none">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h3 class="text-center" style="font-weight: bold; ">www.Arabic-Arabs.com</h3>
        ...
        <div class="row">
            <div class="col-xs-12">
                <img src="{{asset('web_assets/img/new_report_footer.png')}}?v1" width="100%">
            </div>
        </div>
...
<div class="page">
    <div class="subpage-w" style="padding-bottom: 0">
        <div class="row" style="margin-top:20px;">
            <div class="col-xs-12">
                <h1 class="text-center text-red" style="font-weight: bold; font-size: 40px">Usage report - School
                    overall</h1>
            </div>
        </div>
        <br/>
        <div class="row">
            <div class="col-xs-12 text-center">
                <table class="table table-bordered text-center">
                    ...
                    <tr>
                        <td width="40%" class="back-m">Total Teachers</td>
                        <td>{{$data['total_teachers']}}</td>
                    </tr>
                    <tr>
                        <td width="40%" class="back-m">High teacher performance</td>
...
<div class="page">
    <div class="subpage-w" style="padding-bottom: 0">
        <div class="row" style="margin-top:20px;">
            <div class="col-xs-12">
                <h1 class="text-center text-red" style="font-weight: bold; font-size: 40px">Marking State</h1>
            </div>
        </div>
        <br/>
        <div class="row">
            <div class="col-xs-12">
                <div id="teacher_tests"
...
<div class="page">
    <div class="subpage-w" style="padding-bottom: 0">
        <div class="row" style="margin-top:20px;">
            <div class="col-xs-12">
                <h1 class="text-center text-red" style="font-weight: bold; font-size: 40px">Assignment State</h1>
            </div>
        </div>
        <br/>
        <div class="row">
            <div class="col-xs-12">
                <div id="teacher_assignments"
                     style="height: 650px"></div>
            </div>
        </div>
        <br/>
...
<script type='text/javascript'>//<![CDATA[
    ...
    Highcharts.chart('teacher_tests', {
        chart: {
            type: 'bar'
        },
        title: {
        ...
        series: [{
            name: 'Fail',
            data: [@foreach($teachers as $teacher)
    ...
    Highcharts.setOptions({
        colors: ['#ec4102', '#00a5ee', '#f0f303', '#47e51c', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
    });
    Highcharts.chart('teacher_assignments', {
        chart: {
            type: 'bar'
        },
        title: {
