<head>
    ...
    <link href="{{ asset('assets_v1/print/student_card.css') }}" rel="stylesheet" type="text/css" />
    <!-- Favicon -->
                                ...
                                <div class="d-flex flex-column bg-white p-2 h-100" style="border-radius: 8px">
                                    ...
                                    <div class="row mt-1 px-1">
                                        <div class="col-7 d-flex flex-column pe-0">
                                            <div class="col-12 s-content"><span class="s-title">Name : </span>{{ $std->name }}</div>
                                        ...
                                        <div class="col-12 d-flex flex-column gap-1 pe-0">
                                            <div class="s-title">
                                                <ul>
                                                    ...
                                                    <li>Student login</li>
                                                    <li>Email: <span class="username" >{{ $std->email}}</span></li>
                                                    <li>Login</li>
                                                </ul>
                                            </div>
                                        </div>
