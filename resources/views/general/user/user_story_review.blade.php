                            ...
                            <div class="d-flex flex-column flex-grow-1 pe-8">
                                ...
                                <div class="d-flex flex-wrap text-center">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            <div class="fs-2 fw-bold counted" data-kt-countup="true"
                                                 data-kt-countup-value="{{$data['watching_avg']}}"
                                                 data-kt-countup-prefix="%"
                                                 data-kt-initialized="1">{{$data['watching_avg']}}%
                                            </div>
                                        </div>
                                        <!--end::Number-->

                                        <!--begin::Label-->
                                        <div class="fw-semibold fs-6 text-gray-500">{{t('Watching')}}</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                    <!--begin::Stat-->
                                    <div
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            <div class="fs-2 fw-bold counted" data-kt-countup="true"
                                                 data-kt-countup-value="{{$data['reading_avg']}}"
                                                 data-kt-countup-prefix="%"
                                                 data-kt-initialized="1">{{$data['reading_avg']}}%
                                            </div>
                                        </div>
                                        <!--end::Number-->

                                        <!--begin::Label-->
                                        <div class="fw-semibold fs-6 text-gray-500">{{t('Reading')}}</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                    <!--begin::Stat-->
