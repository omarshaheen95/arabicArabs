...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets_v1/web_assets/css/custom.css')}}">
    <link rel="stylesheet" href="{{asset('assets_v1/web_assets/css/responsive.css')}}">
...
<script src="{{asset('assets_v1/web_assets/js/jquery-3.6.3.min.js')}}"></script>
<script src="{{asset('assets_v1/web_assets/js/popper-2.9.2.min.js')}}"></script>
